...
var formatItemParams = function (items, params) {
  items.forEach(function(item, idx){
    var itemKey = ['Item', idx, item.type].join('.'),
      qtyKey = ['Item', idx, 'Quantity'].join('.');
    params[itemKey] = item.id;
    params[qtyKey] = item.qty;
  })
}
